...
class Envato
{
	...
	*/
	...
	public function __construct(Repository $config)
	{
		...
		$this->config      = $config;
		$this->username    = $this->config->get('prestaspirit/envato::username');
		$this->api_key     = $this->config->get('prestaspirit/envato::api_key');
		$this->private_url = 'https://marketplace.envato.com/api/v3/' .$this->username. '/' .$this->api_key. '/';
		$this->public_url  = 'https://marketplace.envato.com/api/v3/set.json';
	}
